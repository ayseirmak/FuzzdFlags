...
# -------------------------------------------------------
su - user42
wget https://raw.githubusercontent.com/ayseirmak/FuzzdFlags/refs/heads/main/2-FP-dataset/1-afl-vanilla/1-fuzz-afl-vanilla-o2/exp11-dock.dockerfile
wget https://raw.githubusercontent.com/ayseirmak/FuzzdFlags/refs/heads/main/2-FP-dataset/extract_fuzz_stat_dir.sh
chmod +x *.sh

# Build Docker image from the local Dockerfile
docker build -f exp11-dock.dockerfile -t afl-vanilla-img .
