...
RUN wget https://github.com/ayseirmak/FuzzdFlags/releases/download/v1.0-alpha/AFL-latest.tar.gz && \
...
RUN wget https://github.com/ayseirmak/FuzzdFlags/releases/download/v1.0-alpha/C-programset-reindexed.tar.gz && \
...
RUN wget https://raw.githubusercontent.com/ayseirmak/FuzzdFlags/refs/heads/main/2-FP-dataset/24_fuzz.sh && \
    wget https://raw.githubusercontent.com/ayseirmak/FuzzdFlags/refs/heads/main/2-FP-dataset/1-afl-vanilla/1-fuzz-afl-vanilla-o3/run_AFL_conf_fp_o3.sh && \
    chmod +x *.sh && \
    rm *.tar.gz
